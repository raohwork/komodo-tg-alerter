...
var rootCmd = &cobra.Command{
	Use:   "komodo-tg-alerter",
	Short: "An alerting tool for Komodo platform that sends alerts to Telegram",
}
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName("komodo-tg-alerter")
	}

	viper.SetEnvPrefix("KTA")
